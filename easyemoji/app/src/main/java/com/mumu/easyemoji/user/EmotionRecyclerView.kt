...
import com.mumu.easyemoji.user.itemprovider.CommentItemProvider
import com.mumu.easyemoji.user.itemprovider.HeadItemProvider
import com.mumu.easyemoji.user.itemprovider.DisplayUtils
import com.mumu.easyemoji.user.itemprovider.SpUtil
import java.util.*

class EmotionRecyclerView(context: Context, attrs: AttributeSet? = null) : RecyclerView(context, attrs),
    LatelyEmotionRecyclerView.LatelyEmotionItemClickListener {
