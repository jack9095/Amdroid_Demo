...
object StatusBarHelper {
    ...
    fun translucent(window: Window, @ColorInt colorOn5x: Int): Unit {
        ...
        if (ScreenUtil.isFlymeLowerThan8() || ScreenUtil.isMIUI() &&
...
//            }
    ...
    fun supportTransclentStatusBar6(): Boolean {
        return !(ScreenUtil.isZUKZ1() || ScreenUtil.isZTKC2016())
    }
    ...
    private fun supportTranslucent(): Boolean {
        ...
        return (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                && !(ScreenUtil.isEssentialPhone() && Build.VERSION.SDK_INT < 26))
    }
    ...
    private fun Android6SetStatusBarLightMode(window: Window, light: Boolean): Boolean {
        ...
        if (ScreenUtil.isMIUIV9()) { // MIUI 9 低于 6.0 版本依旧只能回退到以前的方案
    ...
    private fun isMIUICustomStatusBarLightModeImpl(): Boolean {
        return if (ScreenUtil.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            true
        } else ScreenUtil.isMIUIV5() || ScreenUtil.isMIUIV6() ||
                ScreenUtil.isMIUIV7() || ScreenUtil.isMIUIV8()
    }
