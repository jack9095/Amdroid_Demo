package com.kuanquan.mylibrary.aidl;
...
import com.kuanquan.mylibrary.IBinderPool;
import com.kuanquan.mylibrary.aidl.mainpro.MainProAidlInterface;
import com.kuanquan.mylibrary.aidl.mainpro.MainProHandleRemoteService;
        ...
        public IBinder queryBinder(int binderCode) throws RemoteException {
            ...
            switch (binderCode) {
                case BINDER_WEB_AIDL: {
                    binder = (IBinder) new MainProAidlInterface(context);
                    break;
                }
                default:
                    break;
