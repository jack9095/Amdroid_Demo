...
public class HttpUrlLoader implements ModelLoader<GlideUrl, InputStream> {
    /**
    ...
    public HttpUrlLoader(@Nullable ModelCache<GlideUrl, GlideUrl> modelCache) {
    ...
    /**
     * The default factory for {@link HttpUrlLoader}s.
     */
    public static class Factory implements ModelLoaderFactory<GlideUrl, InputStream> {
        ...
        public ModelLoader<GlideUrl, InputStream> build(MultiModelLoaderFactory multiFactory) {
            return new HttpUrlLoader(modelCache);
        }
