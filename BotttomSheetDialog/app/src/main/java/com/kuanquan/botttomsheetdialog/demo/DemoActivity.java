...
public class DemoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetector(DemoActivity.this,
    ...
    private void initBottomSheetDialog2() {
        ...
        recyclerAdapter.setOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(View item, int position) {
                Toast.makeText(DemoActivity.this, "item "+position, Toast.LENGTH_SHORT).show();
                bottomSheetDialog.dismiss();
            }
        });
    ...
    private void initBottomSheetDialog3() {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(DemoActivity.this);
        View view = View.inflate(DemoActivity.this, R.layout.bottom_sheet_dialog_share, null);
        dialog.setContentView(view);
        recyclerView = (RecyclerView) dialog.findViewById(R.id.recycler);
        recyclerView.setLayoutManager(new GridLayoutManager(DemoActivity.this, 3));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new ShareRecyclerViewAdapter(DemoActivity.this,dialog));
        dialog.show();
