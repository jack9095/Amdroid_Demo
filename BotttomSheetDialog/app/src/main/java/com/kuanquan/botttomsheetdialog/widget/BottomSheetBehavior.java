...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static ContentUIType mContentUIType = ContentUIType.DEFAULT;

    public void setContentUIType(ContentUIType type) {
        mContentUIType =type;
    }
    ...
    // 底部列表 是否滑动到顶部
    private boolean listIsToTop(){
        if (mContentUIType == ContentUIType.ALBUM && mViewPager != null){
            int currentIndex = mViewPager.getCurrentItem();
            RecyclerView recyclerView = (RecyclerView) ((FrameLayout) mViewPager.getChildAt(currentIndex)).getChildAt(0);
