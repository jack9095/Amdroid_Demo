...
public class OnLineAudioReceiver {
     ...
     * 注册成功广播
     */
    private String ACTION_ONLINEMUSICSUCCESS = "com.kuanquan.music_lyric.online.music.success_" + new Date().getTime();
    public static String ACTION_ONLINEMUSICDOWNLOADING = "com.kuanquan.music_lyric.online.music.downloading";
    public static String ACTION_ONLINEMUSICERROR = "com.kuanquan.music_lyric.online.music.error";
