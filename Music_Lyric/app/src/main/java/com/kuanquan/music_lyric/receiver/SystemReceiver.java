...
public class SystemReceiver {
     ...
     * 注册成功广播
     */
    private String ACTION_SUCCESS = "com.kuanquan.music_lyric.system.success_" + new Date().getTime();
    /**
     * 弹出窗口提示
     */
    public static String ACTION_TOASTMESSAGE = "com.kuanquan.music_lyric.system.toast";
    /**
     * 打开线控
     */
    public static String ACTION_OPENWIREMESSAGE = "com.kuanquan.music_lyric.phone.br.openwire";
    /**
     * 关闭线控
     */
    public static String ACTION_CLOSEWIREMESSAGE = "com.kuanquan.music_lyric.phone.br.closewire";
