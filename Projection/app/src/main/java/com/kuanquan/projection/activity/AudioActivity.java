...
import com.kuanquan.projection.view.MusicDiskView;
...
public class AudioActivity extends BasePlayActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAudioPlayerLoading = findViewById(R.id.audio_player_loading);
        mAudioPlayerPosition = findViewById(R.id.audio_player_position);
        mAudioPlayerDuration = findViewById(R.id.audio_player_duration);
        mAudioPlayerSeek = findViewById(R.id.audio_player_seek);
        mAudioPlayerPlayPause = findViewById(R.id.audio_player_play_pause);
        mAudioPlayerPlayPause.setOnClickListener(v -> {
            onAudioPlayPauseClicked();
        });
        mMainContainer = findViewById(R.id.main_container);
        mControlsContainer = findViewById(R.id.audio_player_controls_container);
        mAudioPlayerImage = findViewById(R.id.audio_player_image);
        initAudioPlayer();
