...
import com.kuanquan.commentbanner.banner.transformer.MZScaleInTransformer;
import com.kuanquan.commentbanner.banner.transformer.ScaleInTransformer;
import com.kuanquan.commentbanner.banner.util.BannerLifecycleObserver;
import com.kuanquan.commentbanner.banner.util.BannerLifecycleObserverAdapter;
import com.kuanquan.commentbanner.banner.util.BannerUtils;
import com.kuanquan.commentbanner.banner.util.LogUtils;
...
public class BannerCopy<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    public BannerCopy(Context context) {
        this(context, null);
    }

    public BannerCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerCopy(Context context, AttributeSet attrs, int defStyleAttr) {
...
//     TODO   ScrollSpeedManger.reflectLayoutManager(this);
        addView(mViewPager2);
    ...
    static class AutoLoopTask implements Runnable {
        private final WeakReference<BannerCopy> reference;

        AutoLoopTask(BannerCopy banner) {
            this.reference = new WeakReference<>(banner);
        }

        @Override
        public void run() {
            BannerCopy banner = reference.get();
     ...
     * @return
     */
    public BannerCopy setIntercept(boolean intercept) {
     ...
     * @return
     */
    public BannerCopy setCurrentItem(int position) {
     ...
     * @return
     */
    public BannerCopy setCurrentItem(int position, boolean smoothScroll) {
        getViewPager2().setCurrentItem(position, smoothScroll);
        return this;
    }

    public BannerCopy setIndicatorPageChange() {
        if (mIndicator != null) {
    ...
    public BannerCopy removeIndicator() {
        if (mIndicator != null) {
     ...
     */
    public BannerCopy setStartPosition(int mStartPosition) {
     ...
     */
    public BannerCopy setUserInputEnabled(boolean enabled) {
     ...
     */
    public BannerCopy addPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
     ...
     */
    public BannerCopy setPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
        getViewPager2().setPageTransformer(transformer);
        return this;
    }

    public BannerCopy removeTransformer(ViewPager2.PageTransformer transformer) {
     ...
     * 添加 ItemDecoration
     */
    public BannerCopy addItemDecoration(RecyclerView.ItemDecoration decor) {
        getViewPager2().addItemDecoration(decor);
        return this;
    }

    public BannerCopy addItemDecoration(RecyclerView.ItemDecoration decor, int index) {
     ...
     */
    public BannerCopy isAutoLoop(boolean isAutoLoop) {
     ...
     */
    public BannerCopy setLoopTime(long loopTime) {
     ...
     * 设置轮播滑动过程的时间
     */
    public BannerCopy setScrollTime(int scrollTime) {
     ...
     * 设置banner的适配器
     */
    public BannerCopy setAdapter(BA adapter) {
        if (adapter == null) {
     ...
     * @return
     */
    public BannerCopy setAdapter(BA adapter, boolean isInfiniteLoop) {
     ...
     */
    public BannerCopy setDatas(List<T> datas) {
        if (getAdapter() != null) {
     ...
     */
    public BannerCopy setOrientation(@Orientation int orientation) {
     ...
     * 改变最小滑动距离
     */
    public BannerCopy setTouchSlop(int mTouchSlop) {
     ...
     * 设置点击事件
     */
    public BannerCopy setOnBannerListener(OnBannerListener listener) {
        if (getAdapter() != null) {
     ...
     * </p>
     */
    public BannerCopy addOnPageChangeListener(OnPageChangeListener pageListener) {
     ...
     * @param radius 圆角半径
     */
    public BannerCopy setBannerRound(float radius) {
    ...
    public BannerCopy setBannerRound2(float radius) {
     ...
     */
    public BannerCopy setBannerGalleryEffect(int itemWidth, int pageMargin) {
     ...
     * @param pageMargin 页面间距,单位dp
     */
    public BannerCopy setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin) {
     ...
     */
    public BannerCopy setBannerGalleryEffect(int itemWidth, int pageMargin, float scale) {
     ...
     * @param scale      缩放[0-1],1代表不缩放
     */
    public BannerCopy setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin, float scale) {
        if (pageMargin > 0) {
     ...
     * @param itemWidth item左右展示的宽度,单位dp
     */
    public BannerCopy setBannerGalleryMZ(int itemWidth) {
     ...
     * @param scale     缩放[0-1],1代表不缩放
     */
    public BannerCopy setBannerGalleryMZ(int itemWidth, float scale) {
        if (scale < 1 && scale > 0) {
     ...
     * 设置轮播指示器(显示在banner上)
     */
    public BannerCopy setIndicator(Indicator indicator) {
     ...
     */
    public BannerCopy setIndicator(Indicator indicator, boolean attachToBanner) {
        removeIndicator();
    ...
    public BannerCopy setIndicatorSelectedColor(@ColorInt int color) {
        if (mIndicator != null) {
    ...
    public BannerCopy setIndicatorSelectedColorRes(@ColorRes int color) {
        setIndicatorSelectedColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public BannerCopy setIndicatorNormalColor(@ColorInt int color) {
        if (mIndicator != null) {
    ...
    public BannerCopy setIndicatorNormalColorRes(@ColorRes int color) {
        setIndicatorNormalColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public BannerCopy setIndicatorGravity(@IndicatorConfig.Direction int gravity) {
    ...
    public BannerCopy setIndicatorSpace(int indicatorSpace) {
        if (mIndicator != null) {
    ...
    public BannerCopy setIndicatorMargins(IndicatorConfig.Margins margins) {
        if (mIndicator != null && mIndicator.getIndicatorConfig().isAttachToBanner()) {
    ...
    public BannerCopy setIndicatorWidth(int normalWidth, int selectedWidth) {
        if (mIndicator != null) {
    ...
    public BannerCopy setIndicatorNormalWidth(int normalWidth) {
        if (mIndicator != null) {
            mIndicator.getIndicatorConfig().setNormalWidth(normalWidth);
        }
        return this;
    ...
    public BannerCopy setIndicatorSelectedWidth(int selectedWidth) {
        if (mIndicator != null) {
            mIndicator.getIndicatorConfig().setSelectedWidth(selectedWidth);
        }
        return this;
    ...
    public BannerCopy<T, BA> setIndicatorRadius(int indicatorRadius) {
        if (mIndicator != null) {
    ...
    public BannerCopy<T, BA> setIndicatorHeight(int indicatorHeight) {
        if (mIndicator != null) {
    ...
    public BannerCopy addBannerLifecycleObserver(LifecycleOwner owner) {
        if (owner != null) {
