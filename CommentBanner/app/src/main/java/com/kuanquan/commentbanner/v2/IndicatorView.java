...
public class IndicatorView extends View implements Indicator {
    ...
    private int unColor = Color.GRAY; // 没选中的颜色
    private int selectedColor = Color.WHITE; // 选中后的颜色
    ...
    /*--------------- 核心控制点大小距离参数 ---------------*/
    private float indicatorRadius = dip2px(3.5f); // 半径
    private float indicatorRatio = 1.0f; // 比例
    private float indicatorSelectedRadius = dip2px(3.5f);
    private float indicatorSelectedRatio = 1.0f;
    private float indicatorSpacing = dip2px(10); // 间距
    /*--------------- 核心控制点大小距离参数end ---------------*/
