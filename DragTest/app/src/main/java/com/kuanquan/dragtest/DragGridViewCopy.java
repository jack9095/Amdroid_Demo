 ...
 */
public class DragGridViewCopy extends GridView {
    public static final String TAG = DragGridViewCopy.class.getSimpleName();
    /**
    ...
    public DragGridViewCopy(Context context) {
        this(context, null);
    }

    public DragGridViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragGridViewCopy(Context context, AttributeSet attrs, int defStyle) {
